...
exports.processPayment = async (req, res) => {
    try {
        ...
        const seatLabels = Array.isArray(splitLabels) && splitLabels.length > 0
          ? splitLabels
          : (Array.isArray(seats) ? seats.map((seat) => String(seat)) : []);
        const splitSummary = calculateSplitBreakdown(amount, splitCount || seatLabels.length || 1, seatLabels);
