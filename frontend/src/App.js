...
import VerifyTicketPage from "./pages/customers/VerifyTicketPage.jsx";
    ...
    <SearchProvider>
      <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
        ...
        <Routes>
          ...
          <Route path="/ticket-types/:showtimeId" element={<TicketTypePage />} />
          ...
          <Route path="/e-ticket/:id" element={<VerifyTicketPage />} />
