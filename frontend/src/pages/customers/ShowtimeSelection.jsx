...
const ShowtimeSelection = () => {
  ...
  return (
    <div className="selection-page">
      <button className="selection-back-btn" onClick={() => navigate(-1)}>
        <FaArrowLeft />
      ...
      >
        <div className="header-container">
          ...
          <div className="header-content">
            <span className="selection-eyebrow">Now booking</span>
            <h1>{movie.title}</h1>
      ...
      <div className="date-bar-container">
        <div className="date-bar-heading">
          <div>
            <span className="selection-eyebrow">Plan your visit</span>
            <h2>Choose a date and showtime</h2>
          </div>
